...
//            appearance.setRender(signatureInfo.getRenderingMode());
//            // 摘要算法
//            ExternalDigest digest = new BouncyCastleDigest();
//            // 签名算法
//            PdfSigGenericPKCS.PPKLite lite = new PdfSigGenericPKCS.PPKLite();
//            lite.setSignInfo(signatureInfo.getPk(),signatureInfo.getChain(),null);
//
...
//            String pkPath = "D:\\Java\\jdk1.8.0_291\\bin\\qwz.p12";
...
//            signInfo.setDigestAlgorithm("SHA1");
//            signInfo.setFieldName("demo");
//            // 签章图片
//            signInfo.setImagePath("E:\\Code\\qwz\\qwz-sample\\basic\\b-pdf\\src\\test\\java\\com\\qinweizhao\\basic\\pdf\\out\\1.png");
//            signInfo.setRenderingMode(SignatureRenderDescription);
...
//            //签章后的pdf路径
//            app.sign(path, "E:\\Code\\qwz\\qwz-sample\\basic\\b-pdf\\src\\test\\java\\com\\qinweizhao\\basic\\pdf\\out\\drawingLine-out.pdf", signInfo);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//    }
