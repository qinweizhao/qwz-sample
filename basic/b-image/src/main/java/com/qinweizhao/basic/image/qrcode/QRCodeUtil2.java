...
/**
 */
public final class QRCodeUtil2 extends LuminanceSource {
    ...
    public QRCodeUtil2(BufferedImage image) {
        this(image, 0, 0, image.getWidth(), image.getHeight());
    }

    public QRCodeUtil2(BufferedImage image, int left, int top, int width, int height) {
        super(width, height);
    ...
    public LuminanceSource crop(int left, int top, int width, int height) {
        return new QRCodeUtil2(image, this.left + left, this.top + top, width, height);
    }
    ...
    public LuminanceSource rotateCounterClockwise() {
        ...
        g.dispose();
        int width = getWidth();
        return new QRCodeUtil2(rotatedImage, top, sourceWidth - (left + width), getHeight(), width);
    }
    ...
    public static String parseQRCode(String filePath) {
        ...
        try {
            ...
            LuminanceSource source = new QRCodeUtil2(image);
    ...
    public static void main(String[] args) {
        ...
        try {
            // 生成二维码图片，并返回图片路径
            String pathName = generateQRCode(text, width, height, format, "/Users/weizhao/Code/qwz/qwz-sample/basic/b-image/src/main/resources/out/new.png");
            System.out.println("生成二维码的图片路径： " + pathName);

            String content = parseQRCode(pathName);//解析二维码
